	...
	function D(e) {
		...
		if ((l.originalEvent && (l = l.originalEvent), i.isTouched)) {
			if (!i.isTouchEvent || 'touchmove' === l.type) {
				...
				if (!a.allowTouchMove)
					return (a.allowClick = !1), void (i.isTouched && (C(n, {startX: p, startY: c, currentX: p, currentY: c}), (i.touchStartTime = x())));
		...
		V = {
			...
			slide: {
				slideTo: function (e, t, a, i) {
					if (
						(void 0 === e && (e = 0), void 0 === t && (t = this.params.speed), void 0 === a && (a = !0), 'number' != typeof e && 'string' != typeof e)
					)
						...
						if (l && e.currentBreakpoint !== l) {
							...
							d &&
								['slidesPerView', 'spaceBetween', 'slidesPerGroup', 'slidesPerGroupSkip', 'slidesPerColumn'].forEach(function (e) {
									...
									void 0 !== t &&
										(d[e] =
											'slidesPerView' !== e || ('AUTO' !== t && 'auto' !== t) ? ('slidesPerView' === e ? parseFloat(t) : parseInt(t, 10)) : 'auto');
								});
	...
	var K = {
			...
			load: function () {
				...
				if (n.loadPrevNext)
					if (o > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
						for (
							var c = n.loadPrevNextAmount, u = o, h = Math.min(s + u + Math.max(c, u), i.length), v = Math.max(s - Math.max(u, c), 0), f = s + o;
							f < h;
							f += 1
						)
		...
		ie = {
			...
			getInterpolateFunction: function (e) {
				var t = this;
				t.controller.spline ||
					(t.controller.spline = t.params.loop ? new ie.LinearSpline(t.slidesGrid, e.slidesGrid) : new ie.LinearSpline(t.snapGrid, e.snapGrid));
			},
			setTranslate: function (e, t) {
				var a,
					i,
			...
			init: function () {
				...
				return (
					t.swiper instanceof a
						...
						: S(t.swiper) &&
						  ((e.thumbs.swiper = new a(C({}, t.swiper, {watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1}))),
